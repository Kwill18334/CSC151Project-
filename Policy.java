...
{  //fields
   ...
   //We get the BMI of the policy holder 
   ...
   //We have to get the price in the project is says Include a method that calculates and returns the price of the insurance policy*
   public double getPrice()
   {
      final double BASE_PRICE = 600; //The Insurance Policy has a base fee of $600
